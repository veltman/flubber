...
tape("pathStringToRing", function(test) {
  ...
  test.deepEqual(pathStringToRing(square, 100), [[0, 0], [100, 0], [100, 100], [0, 100]]);
  test.deepEqual(pathStringToRing(square, 50), [
    [0, 0],
    [50, 0],
    [100, 0],
    [100, 50],
  ...
  test.inDelta(
    pathStringToRing(halfcircle, 50),
    [
      [0, 0],
